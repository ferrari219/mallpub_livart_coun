...
(function (t, n) {
			...
			(M = M.merge(M.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', '#000'))),
				...
				(E = E.merge(
					k
						...
						.attr(p, A * _)
						.attr(C, 0.5)
						.attr('dy', t === lf ? '0em' : t === pf ? '0.71em' : '0.32em')
				)),
				e !== w &&
					((M = M.transition(e)),
					(T = T.transition(e)),
				...
				N.remove(),
				M.attr('d', t === df || t == hf ? 'M' + A * l + ',' + m + 'H0.5V' + x + 'H' + A * l : 'M' + m + ',' + A * l + 'V0.5H' + x + 'V' + A * l),
				...
				w
					...
					.attr('text-anchor', t === hf ? 'start' : t === df ? 'end' : 'middle'),
				w.each(function () {
					this.__axis = b;
				});
		}
	...
	function Mt(t) {
		...
		return (
			...
			(n = Sl.exec(t))
				? ((n = parseInt(n[1], 16)), new Et(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
				: (n = El.exec(t))
				? Tt(parseInt(n[1], 16))
				: (n = Al.exec(t))
	...
	function Ct(t) {
		...
		var n = t.r / 255,
			...
			a = o - i,
			c = (o + i) / 2;
		return a ? ((u = n === o ? (e - r) / a + 6 * (e < r) : e === o ? (r - n) / a + 2 : (n - e) / a + 4), (a /= c < 0.5 ? o + i : 2 - o - i), (u *= 60)) : (a = c > 0 && c < 1 ? 0 : u), new Pt(u, a, c, t.opacity);
	}
	function zt(t, n, e, r) {
	...
	function qt(t) {
		...
		var e = It(t.r),
			r = It(t.g),
			i = It(t.b),
			o = Dt((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Fl),
			u = Dt((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Il),
			a = Dt((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Yl);
	...
	function en(t) {
		return 'none' === t
			? wh
			: (th || ((th = document.createElement('DIV')), (nh = document.documentElement), (eh = document.defaultView)),
			  (th.style.transform = t),
			  (t = eh.getComputedStyle(nh.appendChild(th), null).getPropertyValue('transform')),
			  nh.removeChild(th),
			  (t = t.slice(7, -1).split(',')),
			  Mh(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
	}
	function rn(t) {
	...
	function on(t, n, e, r) {
		...
		function u(t, n, e, o) {
			t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + 'rotate(', null, r) - 2, x: dh(t, n) })) : n && e.push(i(e) + 'rotate(' + n + r);
		}
		function a(t, n, e, o) {
			t !== n ? o.push({ i: e.push(i(e) + 'skewX(', null, r) - 2, x: dh(t, n) }) : n && e.push(i(e) + 'skewX(' + n + r);
		}
			...
			function o() {
				...
				switch (((m = O[0] - D[0]), (x = O[1] - D[1]), k)) {
					...
					case ad:
						...
						break;
					case sd:
						S < 0 ? ((m = Math.max(P - l, Math.min(q - l, m))), (h = l + m), (_ = v)) : S > 0 && ((m = Math.max(P - v, Math.min(q - v, m))), (h = l), (_ = v + m)),
							E < 0 ? ((x = Math.max(R - p, Math.min(L - p, x))), (d = p + x), (g = y)) : E > 0 && ((x = Math.max(R - y, Math.min(L - y, x))), (d = p), (g = y + x));
						break;
					case fd:
				...
				_ < h && ((S *= -1), (t = l), (l = v), (v = t), (t = h), (h = _), (_ = t), N in vd && Y.attr('cursor', dd[(N = vd[N])])),
					g < d && ((E *= -1), (t = p), (p = y), (y = t), (t = d), (d = g), (g = t), N in _d && Y.attr('cursor', dd[(N = _d[N])])),
	...
	function qr(t, n) {
		...
		if (Jv) {
			...
			var u,
				...
				s = o[0] * M_ * c,
				f = N_(a) > 180;
			f ^ (c * $v < s && s < c * t) ? ((u = o[1] * M_), u > Wv && (Wv = u)) : ((s = ((s + 360) % 360) - 180), f ^ (c * $v < s && s < c * t) ? ((u = -o[1] * M_), u < Xv && (Xv = u)) : (n < Xv && (Xv = n), n > Wv && (Wv = n))),
				f ? (t < $v ? Ir(Hv, t) > Ir(Hv, Vv) && (Vv = t) : Ir(t, Vv) > Ir(Hv, Vv) && (Hv = t)) : Vv >= Hv ? (t < Hv && (Hv = t), t > Vv && (Vv = t)) : t > $v ? Ir(Hv, t) > Ir(Hv, Vv) && (Vv = t) : Ir(t, Vv) > Ir(Hv, Vv) && (Hv = t);
		} else Rr(t, n);
		(Jv = e), ($v = t);
	}
	function Lr() {
	...
	function vi() {
		...
		function n() {
			return Is(A_(o / _) * _, i, _)
				.map(h)
				.concat(Is(A_(s / y) * y, c, y).map(p))
				.concat(
					Is(A_(r / d) * d, e, d)
						.filter(function (t) {
							return N_(t % _) > y_;
		...
		return {
			...
			point: function (o, u) {
				var a = o > 0 ? m_ : -m_,
					c = N_(o - e);
				N_(c - m_) < y_
					? (t.point(e, (r = (r + u) / 2 > 0 ? x_ : -x_)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), (n = 0))
					: i !== a && c >= m_ && (N_(e - i) < y_ && (e -= i * y_), N_(o - a) < y_ && (o -= a * y_), (r = Di(e, r, o, u)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), (n = 0)),
					t.point((e = o), (r = u)),
					(i = a);
			},
			lineEnd: function () {
		...
		function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
			...
			if (m > 4 * n && v--) {
				var x = u + h,
					...
					C = E - i,
					z = g * A - y * C;
				((z * z) / m > n || N_((y * A + g * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < Jy) && (e(r, i, o, u, a, c, S, E, N, (x /= M), (b /= M), w, v, _), _.point(S, E), e(S, E, N, x, b, w, s, f, l, h, p, d, v, _));
			}
		}
		return function (n) {
			function r(e, r) {
	...
	function Vi(t) {
		...
		return (
			...
			(n.clipExtent = function (t) {
				return arguments.length
					? ((S = null == t ? ((k = l = h = p = null), Ty) : ci((k = +t[0][0]), (l = +t[0][1]), (h = +t[1][0]), (p = +t[1][1]))), o())
					: null == k
					? null
					: [
							[k, l],
	...
	function Eo(t, n) {
		...
		for (; u; )
			(i = u._),
				(r = u.next),
				e && So(e, i) ? (o = u) : (o ? ((t.tail = o), (o.next = null)) : (t.head = t.tail = null), n.push(i), (e = Eo(t, n)), n.pop(), t.head ? ((u.next = t.head), (t.head = u)) : ((u.next = null), (t.head = t.tail = u)), (o = t.tail), (o.next = r)),
				(u = r);
		return (t.tail = o), e;
	}
	function Ao(t) {
	...
	function Wu(t) {
		...
		var w = t.dateTime,
			...
			O = Gu(A),
			F = Ju(A),
			I = { a: h, A: p, b: d, B: v, c: null, d: ha, e: ha, H: pa, I: da, j: va, L: _a, m: ya, M: ga, p: _, S: ma, U: xa, w: ba, W: wa, x: null, X: null, y: Ma, Y: Ta, Z: Na, '%': Ia },
			Y = { a: y, A: g, b: m, B: x, c: null, d: ka, e: ka, H: Sa, I: Ea, j: Aa, L: Ca, m: za, M: Pa, p: b, S: Ra, U: qa, w: La, W: Ua, x: null, X: null, y: Da, Y: Oa, Z: Fa, '%': Ia },
			B = { a: o, A: u, b: a, B: c, c: s, d: oa, e: oa, H: aa, I: aa, j: ua, L: fa, m: ia, M: ca, p: i, S: sa, U: Ku, w: Qu, W: ta, x: f, X: l, y: ea, Y: na, Z: ra, '%': la };
		return (
			(I.x = n(M, I)),
			(I.X = n(T, I)),
			(I.c = n(w, I)),
	...
	function Tc(t, n, e) {
		var r = t._x1 - t._x0,
			...
			u = (e - t._y1) / (i || (r < 0 && -0)),
			a = (o * i + u * r) / (r + i);
		return (Mc(o) + Mc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0;
	}
	function Nc(t, n) {
		var e = t._x1 - t._x0;
	...
	function Qc(t) {
		return (yw[t.index] = { site: t, halfedges: [] });
	}
	function Kc(t, n) {
		var e = t.site,
			r = n.left,
			...
			if ((o = yw[i])) {
				...
				for (a = 0, s = c.length; a < s; )
					(p = ns(o, mw[c[a]])),
						...
						(l = f[0]),
						(h = f[1]),
						(Math.abs(d - l) > ww || Math.abs(v - h) > ww) &&
							(c.splice(
								a,
								0,
								mw.push(
									Wc(
										u,
										p,
										Math.abs(d - t) < ww && r - v > ww
											? [t, Math.abs(l - t) < ww ? h : r]
											: Math.abs(v - r) < ww && e - d > ww
											? [Math.abs(h - r) < ww ? l : e, r]
											: Math.abs(d - e) < ww && v - n > ww
											? [e, Math.abs(l - e) < ww ? h : n]
											: Math.abs(v - n) < ww && d - t > ww
											? [Math.abs(h - n) < ww ? l : t, n]
											: null
									)
								) - 1
							),
	...
	function ws() {
		var t,
			...
			e = this;
		return (
			e instanceof SVGElement ? ((e = e.ownerSVGElement || e), (t = e.width.baseVal.value), (n = e.height.baseVal.value)) : ((t = e.clientWidth), (n = e.clientHeight)),
			[
				[0, 0],
				[t, n],
			]
	...
	var Ts = '4.5.0',
		...
		Ps = function (t, n) {
			var e,
				...
				a = -1,
				c = 0;
			if (null == n) for (; ++a < i; ) isNaN((e = zs(t[a]))) || ((r = e - o), (o += r / ++c), (u += r * (e - o)));
			else for (; ++a < i; ) isNaN((e = zs(n(t[a], a, t)))) || ((r = e - o), (o += r / ++c), (u += r * (e - o)));
			if (c > 1) return u / (c - 1);
		},
		Rs = function (t, n) {
			var e = Ps(t, n);
		...
		$s = function (t, n, e) {
			return (t = Ds.call(t, zs).sort(Ns)), Math.ceil((e - n) / (2 * (Ws(t, 0.75) - Ws(t, 0.25)) * Math.pow(t.length, -1 / 3)));
		},
		Zs = function (t, n, e) {
		...
		Js = function (t, n) {
			var e,
				...
				o = -1,
				u = i;
			if (null == n) for (; ++o < i; ) isNaN((e = zs(t[o]))) ? --u : (r += e);
			else for (; ++o < i; ) isNaN((e = zs(n(t[o], o, t)))) ? --u : (r += e);
			if (u) return r / u;
		},
		Qs = function (t, n) {
			var e,
				...
				i = t.length,
				o = -1;
			if (null == n) for (; ++o < i; ) isNaN((e = zs(t[o]))) || r.push(e);
			else for (; ++o < i; ) isNaN((e = zs(n(t[o], o, t)))) || r.push(e);
			return Ws(r.sort(Ns), 0.5);
		},
		Ks = function (t) {
	...
	var yf = 'http://www.w3.org/1999/xhtml',
		gf = { svg: 'http://www.w3.org/2000/svg', xhtml: yf, xlink: 'http://www.w3.org/1999/xlink', xml: 'http://www.w3.org/XML/1998/namespace', xmlns: 'http://www.w3.org/2000/xmlns/' },
		mf = function (t) {
			var n = (t += ''),
				e = n.indexOf(':');
			return e >= 0 && 'xmlns' !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), gf.hasOwnProperty(n) ? { space: gf[n], local: t } : t;
		},
		xf = function (t) {
			var n = mf(t);
	...
	var Ff = function (t) {
		...
		tl = function (t, n, e) {
			...
			return arguments.length > 1
				? this.each((null == n ? I : 'function' == typeof n ? B : Y)(t, n, null == e ? '' : e))
				: Kf((r = this.node()))
	...
	var xl = function () {
			...
			function c(e, r, i, o, u) {
				var a,
					...
					l = _.copy();
				if (
					S(new yt(n, 'beforestart', a, e, y, f[0], f[1], 0, 0, l), function () {
	...
	bl(
		...
		bt(wt, {
			...
			rgb: function () {
				...
				return (t = Il * Ot(t)), (n = Fl * Ot(n)), (e = Yl * Ot(e)), new Et(Ft(3.2404542 * n - 1.5371385 * t - 0.4985314 * e), Ft(-0.969266 * n + 1.8760108 * t + 0.041556 * e), Ft(0.0556434 * n - 0.2040259 * t + 1.0572252 * e), this.opacity);
			},
		})
	),
		bl(
	...
	var th,
		...
		gh = function (t, n) {
			var e,
				...
				a = [],
				c = [];
			for (t += '', n += ''; (e = _h.exec(t)) && (r = yh.exec(n)); )
				(i = r.index) > o && ((i = n.slice(o, i)), a[u] ? (a[u] += i) : (a[++u] = i)), (e = e[0]) === (r = r[0]) ? (a[u] ? (a[u] += r) : (a[++u] = r)) : ((a[++u] = null), c.push({ i: u, x: dh(e, r) })), (o = yh.lastIndex);
			return (
		...
		bh = 180 / Math.PI,
		wh = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 },
		Mh = function (t, n, e, r, i, o) {
			...
			return (
				...
				{ translateX: i, translateY: o, rotate: Math.atan2(n, t) * bh, skewX: Math.atan(c) * bh, scaleX: u, scaleY: a }
			);
		},
		Th = on(en, 'px, ', 'px)', 'deg)'),
		Nh = on(rn, ', ', ')', ')'),
	...
	var Wh = function (t, n, e) {
		...
		ip = function (t, n, e, r, i, o) {
			...
			Nn(t, e, { name: n, index: r, group: i, on: Zh, tween: Gh, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: Jh });
		},
		op = function (t, n) {
			var e,
				r,
	...
	var Ep = 3,
		...
		td = { time: null, delay: 0, duration: 250, ease: ae },
		nd = function (t) {
			var n, e;
	...
	var ed = [null],
		...
		dd = { overlay: 'crosshair', selection: 'move', n: 'ns-resize', e: 'ew-resize', s: 'ns-resize', w: 'ew-resize', nw: 'nwse-resize', ne: 'nesw-resize', se: 'nwse-resize', sw: 'nesw-resize' },
		vd = { e: 'w', w: 'e', nw: 'ne', ne: 'nw', se: 'sw', sw: 'se' },
		_d = { n: 's', s: 'n', nw: 'sw', ne: 'se', se: 'ne', sw: 'nw' },
		yd = { overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1 },
		gd = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 },
		md = function () {
			return Ce(pd);
		},
		xd = Math.cos,
	...
	Pe.prototype = Re.prototype = {
		...
		arc: function (t, n, e, r, i, o) {
			...
			null === this._x1 ? (this._ += 'M' + c + ',' + s) : (Math.abs(this._x1 - c) > zd || Math.abs(this._y1 - s) > zd) && (this._ += 'L' + c + ',' + s),
				e &&
					(l > Pd
						? (this._ += 'A' + e + ',' + e + ',0,1,' + f + ',' + (t - u) + ',' + (n - a) + 'A' + e + ',' + e + ',0,1,' + f + ',' + (this._x1 = c) + ',' + (this._y1 = s))
						: (l < 0 && (l = (l % Cd) + Cd), (this._ += 'A' + e + ',' + e + ',0,' + +(l >= Ad) + ',' + f + ',' + (this._x1 = t + e * Math.cos(i)) + ',' + (this._y1 = n + e * Math.sin(i)))));
		},
	...
	Fe.prototype = Ie.prototype = {
		...
		entries: function () {
			var t = [];
			for (var n in this) n[0] === qd && t.push({ key: n.slice(1), value: this[n] });
			return t;
		},
		size: function () {
			var t = 0;
	...
	(pv.copy = function () {
		...
		for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); ) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = rr(n)));
		return e;
	}),
		(pv.add = tv),
		(pv.addAll = Je),
	...
	var dv,
		vv = function (t) {
						...
						p = l + a;
					{
						...
						if (o.index > c.index) {
							var d = s - o.x - o.vx,
								...
								_ = d * d + v * v;
							_ < p * p &&
								(0 === d && ((d = Kd()), (_ += d * d)), 0 === v && ((v = Kd()), (_ += v * v)), (_ = ((p - (_ = Math.sqrt(_))) / _) * u), (c.vx += (d *= _) * (p = (a *= a) / (h + a))), (c.vy += (v *= _) * p), (o.vx -= d * (p = 1 - p)), (o.vy -= v * p));
						}
					}
				}
			...
			var i,
				...
				a = 1;
			return (
				'function' != typeof t && (t = Qd(null == t ? 1 : +t)),
				...
				for (var e = 0, r = t.length; e < d; ++e)
					for (var i, o, c, s, l, h, p, v = 0; v < r; ++v)
						(i = t[v]),
							(o = i.source),
							(c = i.target),
							(s = c.x + c.vx - o.x - o.vx || Kd()),
							(l = c.y + c.vy - o.y - o.vy || Kd()),
							(h = Math.sqrt(s * s + l * l)),
							(h = ((h - a[v]) / h) * n * u[v]),
							(s *= h),
							(l *= h),
		...
		bv = function (t) {
			...
			var r,
				...
				u = Qd(0.1);
			return (
				'function' != typeof t && (t = Qd(null == t ? 0 : +t)),
				(n.initialize = function (t) {
					(r = t), e();
				}),
				(n.strength = function (t) {
		...
		qv = function (t) {
			function n(t) {
				...
				var e = t.fill,
					...
					y = !p || /[defgprs%]/.test(p);
				return (
					(h = null == h ? (p ? 6 : 12) : /[gprs]/.test(p) ? Math.max(1, Math.min(21, h)) : Math.max(0, Math.min(20, h))),
					(n.toString = function () {
						return t + '';
					}),
					n
	...
	var J_,
		...
		cy = function (t) {
			...
			return (
				(t = ti(t[0] * T_, t[1] * T_, t.length > 2 ? t[2] * T_ : 0)),
				(n.invert = function (n) {
		...
		sy = function () {
			...
			function n() {
				...
				return (e = []), (r = ti(-t[0] * T_, -t[1] * T_, 0).invert), ii(a, n, c, 1), (t = { type: 'Polygon', coordinates: [e] }), (e = r = null), t;
			}
			var e,
				r,
				i = Z_([0, 0]),
		...
		yy = Ov(),
		gy = { sphere: gr, point: gr, lineStart: si, lineEnd: gr, polygonStart: gr, polygonEnd: gr },
		my = function (t) {
			return yy.reset(), F_(t, gy), +yy;
		},
		xy = [null, null],
		by = { type: 'LineString', coordinates: xy },
		wy = function (t, n) {
			...
			function i(t) {
				...
				return {
					...
					point: function (l, h) {
						...
						if ((!n && (a = i = v) && t.lineStart(), v !== i && ((p = o(n, d)), (hy(n, p) || hy(d, p)) && ((d[0] += y_), (d[1] += y_), (v = r(d[0], d[1])))), v !== i))
				...
				(t.translate = function (t) {
					...
					return (
						...
						(o = s
							...
							.clipExtent([
								[r - 0.425 * e + y_, a + 0.12 * e + y_],
								[r - 0.214 * e - y_, a + 0.234 * e - y_],
							])
							.stream(l)),
						(u = f
							.translate([r - 0.205 * e, a + 0.212 * e])
							.clipExtent([
								[r - 0.214 * e + y_, a + 0.166 * e + y_],
								[r - 0.115 * e - y_, a + 0.234 * e - y_],
							])
							.stream(l)),
						n()
					);
		...
		hg = function () {
			...
			return (u = {
				...
				clipExtent: function (i) {
					return arguments.length
						? ((d = null == i ? ((p = n = e = r = null), Ty) : ci((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))), t())
						: null == p
						? null
						: [
								[p, n],
		...
		Pg = function () {
			function t(t) {
				return (
					...
					(t.y = r / 2),
					n
						? t.eachBefore(Bo(n)).eachAfter(jo(i, 0.5)).eachBefore(Ho(1))
						: t
								.eachBefore(Bo(Yo))
								.eachAfter(jo(Io, 1))
								.eachAfter(jo(i, t.r / Math.min(e, r)))
								.eachBefore(Ho(Math.min(e, r) / (2 * t.r))),
					t
				);
			}
			var n = null,
	...
	var Ux = '%Y-%m-%dT%H:%M:%S.%LZ',
		...
		Kx = Uh(Xt(300, 0.5, 0), Xt(-240, 0.5, 1)),
		tb = Uh(Xt(-100, 0.75, 0.35), Xt(80, 1.5, 0.8)),
		nb = Uh(Xt(260, 0.75, 0.35), Xt(80, 1.5, 0.8)),
		eb = Xt(),
		rb = function (t) {
			(t < 0 || t > 1) && (t -= Math.floor(t));
			var n = Math.abs(t - 0.5);
			return (eb.h = 360 * t - 100), (eb.s = 1.5 - 1.5 * n), (eb.l = 0.8 - 0.9 * n), eb + '';
		},
		ib = Wa(
			$x(
						...
						M > sb
							? E > sb
								? ((_ = ec(D, O, z, P, l, E, v)),
								  ...
								  E < k
										? c.arc(_.cx, _.cy, E, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v)
										: (c.arc(_.cx, _.cy, E, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v),
										  c.arc(0, 0, l, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), !v),
										  c.arc(y.cx, y.cy, E, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v)))
								...
								? S > sb
									? ((_ = ec(R, q, L, U, f, -S, v)),
									  ...
									  S < k
											...
											: (c.arc(_.cx, _.cy, S, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v),
											  c.arc(0, 0, f, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), v),
											  c.arc(y.cx, y.cy, S, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v)))
									: c.arc(0, 0, f, b, x, v)
								: c.lineTo(R, q);
					}
				else c.moveTo(0, 0);
		...
		mb = function () {
			function t(t) {
				...
				for (
					...
					(c = d[a]), (l = v[c]), (f = _ + (l > 0 ? l * s : 0) + m), (v[c] = { data: t[c], index: a, value: l, startAngle: _, endAngle: f, padAngle: g });
				return v;
			}
			var n = gb,
				e = yb,
		...
		Ib = {
			draw: function (t, n) {
				...
				t.moveTo(r, i),
					t.lineTo(o, u),
					t.lineTo(a, c),
					t.lineTo(Ub * r - Db * i, Db * r + Ub * i),
					t.lineTo(Ub * o - Db * u, Db * o + Ub * u),
					t.lineTo(Ub * a - Db * c, Db * a + Ub * c),
					t.lineTo(Ub * r + Db * i, Ub * i - Db * r),
					t.lineTo(Ub * o + Db * u, Ub * u - Db * o),
					t.lineTo(Ub * a + Db * c, Ub * c - Db * a),
					t.closePath();
			},
		},
		...
		(Pc.prototype = {
			...
			lineEnd: function () {
				...
				if (e)
					...
					else for (var r = Rc(t), i = Rc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
	...
	Yc.prototype = {
		...
		insert: function (t, n) {
			...
			for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
				(r = e.U),
					e === r.L
						? ((i = r.R), i && i.C ? ((e.C = i.C = !1), (r.C = !0), (t = r)) : (t === e.R && (jc(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), Hc(this, r)))
						: ((i = r.L), i && i.C ? ((e.C = i.C = !1), (r.C = !0), (t = r)) : (t === e.L && (Hc(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), jc(this, r))),
					(e = t.U);
			this._.C = !1;
		},
		remove: function (t) {
			...
			if (
				...
				o && u ? ((r = e.C), (e.C = t.C), (e.L = o), (o.U = e), e !== u ? ((i = e.U), (e.U = t.U), (t = e.R), (i.L = t), (e.R = u), (u.U = e)) : ((e.U = i), (i = e), (t = e.R))) : ((r = t.C), (t = e)),
				t && (t.U = i),
				!r)
			) {
				...
				this.cells.forEach(function (e, r) {
					if ((o = (i = e.halfedges).length))
						for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o; )
							(u = f), (s = n[i[c]]), (f = s.left === a ? s.right : s.left), u && f && r < u.index && r < f.index && ds(a, u, f) < 0 && t.push([a.data, u.data, f.data]);
				}),
				t
			);
		},
		...
		Ew = function () {
			...
			function h() {
				if (g.apply(this, arguments)) {
					...
					return _ && ((_ = clearTimeout(_)), !o.touch1)
						? (o.end(), (i = pl(this).on('dblclick.zoom')), void (i && i.apply(this, arguments)))
						: void (
								n &&
			...
			return (
				...
				(n.translateExtent = function (t) {
					return arguments.length
						? ((w = +t[0][0]), (M = +t[1][0]), (T = +t[0][1]), (N = +t[1][1]), n)
						: [
								[w, T],
								[M, N],
						  ];
	...
	(t.version = Ts),
		...
		(t.easeElasticIn = Jp),
		(t.easeElasticOut = Qp),
		(t.easeElasticInOut = Kp),
		(t.forceCenter = Jd),
		(t.forceCollide = vv),
		(t.forceLink = _v),
		(t.forceManyBody = xv),
		(t.forceSimulation = mv),
		(t.forceX = bv),
		(t.forceY = wv),
		(t.formatDefaultLocale = hr),
		(t.formatLocale = qv),
		(t.formatSpecifier = zv),
		(t.precisionFixed = Lv),
		(t.precisionPrefix = Uv),
		(t.precisionRound = Dv),
		(t.geoArea = j_),
		(t.geoBounds = V_),
		(t.geoCentroid = $_),
		...
		(t.geoAlbers = ng),
		(t.geoAlbersUsa = eg),
		(t.geoAzimuthalEqualArea = ig),
		(t.geoAzimuthalEqualAreaRaw = rg),
		(t.geoAzimuthalEquidistant = ug),
		(t.geoAzimuthalEquidistantRaw = og),
		(t.geoConicConformal = cg),
		(t.geoConicConformalRaw = eo),
		(t.geoConicEqualArea = tg),
		(t.geoConicEqualAreaRaw = Zi),
		(t.geoConicEquidistant = fg),
		(t.geoConicEquidistantRaw = io),
		(t.geoEquirectangular = sg),
		(t.geoEquirectangularRaw = ro),
		(t.geoGnomonic = lg),
		(t.geoGnomonicRaw = oo),
		(t.geoIdentity = hg),
		(t.geoProjection = Xi),
		(t.geoProjectionMutator = Vi),
		(t.geoMercator = ag),
		(t.geoMercatorRaw = Ki),
		(t.geoOrthographic = pg),
		(t.geoOrthographicRaw = ao),
		(t.geoStereographic = dg),
		(t.geoStereographicRaw = co),
		(t.geoTransverseMercator = vg),
		(t.geoTransverseMercatorRaw = so),
		(t.geoRotation = cy),
		(t.geoStream = F_),
		(t.geoTransform = Zy),
		(t.cluster = _g),
		...
		(t.treemapDice = qg),
		(t.treemapSlice = Yg),
		(t.treemapSliceDice = Vg),
		(t.treemapSquarify = jg),
		(t.treemapResquarify = Wg),
		(t.interpolate = mh),
		(t.interpolateArray = hh),
		(t.interpolateBasis = uh),
		(t.interpolateBasisClosed = ah),
		(t.interpolateDate = ph),
		(t.interpolateNumber = dh),
		(t.interpolateObject = vh),
		(t.interpolateRound = xh),
		(t.interpolateString = gh),
		(t.interpolateTransformCss = Th),
		(t.interpolateTransformSvg = Nh),
		(t.interpolateZoom = Ch),
		(t.interpolateRgb = sh),
		(t.interpolateRgbBasis = fh),
		(t.interpolateRgbBasisClosed = lh),
		(t.interpolateHsl = zh),
		(t.interpolateHslLong = Ph),
		(t.interpolateLab = fn),
		(t.interpolateHcl = Rh),
		(t.interpolateHclLong = qh),
		(t.interpolateCubehelix = Lh),
		(t.interpolateCubehelixLong = Uh),
		(t.quantize = Dh),
		(t.path = Re),
		(t.polygonArea = $g),
		(t.polygonCentroid = Zg),
		(t.polygonHull = Jg),
		(t.polygonContains = Qg),
		(t.polygonLength = Kg);
	t.quadtree = nr;
	(t.queue = fu),
		(t.randomUniform = em),
		(t.randomNormal = rm),
		(t.randomLogNormal = im),
		(t.randomBates = um),
		(t.randomIrwinHall = om),
		(t.randomExponential = am),
		(t.request = cm),
		(t.html = fm),
		(t.json = lm),
		(t.text = hm),
		...
		(t.scaleTime = Vx),
		(t.scaleUtc = Wx),
		(t.schemeCategory10 = Zx),
		(t.schemeCategory20b = Gx),
		(t.schemeCategory20c = Jx),
		(t.schemeCategory20 = Qx),
		(t.interpolateCubehelixDefault = Kx),
		(t.interpolateRainbow = rb),
		(t.interpolateWarm = tb),
		(t.interpolateCool = nb),
		(t.interpolateViridis = ib),
		(t.interpolateMagma = ob),
		(t.interpolateInferno = ub),
		(t.interpolatePlasma = ab),
		(t.scaleSequential = $a),
		(t.creator = xf),
		(t.local = x),
		(t.matcher = Nf),
		...
		(t.symbolTriangle = Lb),
		(t.symbolWye = Ib),
		(t.curveBasisClosed = Xb),
		(t.curveBasisOpen = Vb),
		(t.curveBasis = Hb),
		(t.curveBundle = Wb),
		(t.curveCardinalClosed = Zb),
		(t.curveCardinalOpen = Gb),
		(t.curveCardinal = $b),
		(t.curveCatmullRomClosed = Qb),
		(t.curveCatmullRomOpen = Kb),
		(t.curveCatmullRom = Jb),
		(t.curveLinearClosed = tw),
		(t.curveLinear = db),
		(t.curveMonotoneX = Cc),
		(t.curveMonotoneY = zc),
		(t.curveNatural = nw),
		(t.curveStep = ew),
		(t.curveStepAfter = Uc),
		(t.curveStepBefore = Lc),
		(t.stack = uw),
		(t.stackOffsetExpand = aw),
		(t.stackOffsetNone = iw),
		(t.stackOffsetSilhouette = cw),
		(t.stackOffsetWiggle = sw),
		(t.stackOrderAscending = fw),
		(t.stackOrderDescending = lw),
		(t.stackOrderInsideOut = hw),
		(t.stackOrderNone = ow),
		(t.stackOrderReverse = pw),
		(t.timeInterval = Yu),
		(t.timeMillisecond = Em),
		(t.timeMilliseconds = Am),
		(t.utcMillisecond = Em),
		(t.utcMilliseconds = Am),
		(t.timeSecond = Lm),
		(t.timeSeconds = Um),
		(t.utcSecond = Lm),
		(t.utcSeconds = Um),
